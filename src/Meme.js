...
const memeImages = [meme1, meme3, meme4,meme5,meme6,meme7,meme8,meme9,meme10,meme11,meme12,meme13,meme14,meme15]; // Import your meme images
...
const Memes = () => {
  ...
  return (
    <div className="memes-container">
      <button className="im-bored-button" onClick={getRandomMeme}>
        Next
      </button>
      <img
